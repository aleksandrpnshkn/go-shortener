...
//
//	mockgen -destination=internal/mocks/mock_code_generator.go -package=mocks ./internal/services CodeGenerator
//
...
import (
	...
	services "github.com/aleksandrpnshkn/go-shortener/internal/services"
...
func (m *MockCodeGenerator) Generate() services.Code {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Generate")
	ret0, _ := ret[0].(services.Code)
	return ret0
}
