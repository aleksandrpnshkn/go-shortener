// Package batcher представляет собой абстракцию (воркер на базе шаблонного метода) для сбора отдельных операций и последующим выполнением их одной пачкой.
...
// Close останавливает batcher'а. Завершать после остановки хэндлеров.
